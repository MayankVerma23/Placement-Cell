        ...
        <footer id="footer">
            <div class="footer-main-body">
                ...
                <div class="main-2">
                    ...
                    <div class="main-2-b">
                        <h4 style="font-weight:600; margin-bottom: 30px;">Examination</h4>     
                        <p>
                            <a href="#">Declare Result</a><br>
                            <a href="#">Student Section</a><br>
                            <a href="#">Participated Candidates</a><br>
                            <a href="#">Selected Candidates</a><br>
