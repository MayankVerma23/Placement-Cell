 ...
 * @author My Lappy
 */
@WebServlet(urlPatterns = {"/paper_tpo"})
public class paper_tpo extends HttpServlet {
...
if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
 ...
 String query="insert into old_paper values(null,'"+x+"','"+saveFile+"')";
st.execute(query);
                        }
            catch(Exception ex)
            {
  ...
  saveFile="C:/Users/hp/Documents/NetBeansProjects/Placement Cell/web/old_paper/"+saveFile;
