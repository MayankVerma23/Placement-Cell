    ...
    <body>
        <footer id="footer">
            <div class="footer-main-body">
                <div class="main-1">
                    <h4 style="font-weight:600;">News and Updates</h4>
                ...
                <div class="main-2">
                    ...
                    <div class="main-2-b">
                        <h4 style="font-weight:600; margin-bottom: 30px;">Placement</h4>     
                        <p>
                            <a href="#">Results</a><br>
                            <a href="#">Upcoming Companies</a><br>
                            <a href="#">Apply For Job</a><br>
