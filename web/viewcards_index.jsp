            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card shadow" style="width: 20rem; ">
                        <div class="inner"><img class="card-img-top" src="gallery.jpg" alt="..."></div>
                            <div class="card-body text-center">
                                ...
                                <div class="col-md-4">
                    <div class="card shadow" style="width: 20rem;">
                        <div class="inner"> <img class="card-img-top" src="tmemb.jpg" alt="..."></div>
                            <div class="card-body text-center">
                                ...
                                <div class="col-md-4">
                    <div class="card shadow" style="width: 20rem;">
                        <div class="inner"><img class="card-img-top" src="satistics.jpg" alt="..."></div>
                            <div class="card-body text-center">
