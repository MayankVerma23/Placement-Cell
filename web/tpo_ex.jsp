...
<html>
   ...
   <body>
            ...
            <div id="exTab1" class="container">	
                <ul  class="nav nav-pills" style="margin-left:50px;">
                    <li class="active" style="width:50%;text-align:center;background-color:wheat;">
                        <a href="#1" data-toggle="tab" >New Companies Request</a>
                    </li>
                    <li style="width:49%;text-align:center; background-color:wheat;">
                        <a href="#2" data-toggle="tab" >Companies Requirements</a>
                    </li>
                </ul>
            ...
            <%@include file = "placement_tpo1.jsp"%>
        </section>
 
                    </div>
                    <div class="tab-pane" id="2">
                        <%@include file = "company_responsetable1.jsp"%>
                    </div>
